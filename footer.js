...
<footer class="site-footer">
  <div class="footer-upper">
    <div>
      <img src="LOGO-transparent3_white.png" style="height:48px;opacity:0.85;margin-bottom:14px;" alt="ICANJ" onerror="this.style.display='none'"/>
      <div class="footer-tagline">Hackensack, New Jersey</div>
